...
%%%%%%%%%%%%%%%%%%%%%%%%%loading the model for comparison neglect of gravity for simplicity%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
TAU_RT = [];
mdl_panda;
panda.gravity = [0,0,0];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:length(t)
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% neglect of gravity and friction for simplicity%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  TAU(:,i) = M*ddq + c;   %%%% originala torque
  TAU_RT = [TAU_RT;panda.rne(Q(:,i)', dQdt(:,i)', ddQdt(:,i)')];  %%%%% torque computed by Robotics Toolbox
